...
class MathHelperFunctions(object):
    ...
    # for dimension >= [77,28], the approximation error of sqrt(N) * ... with [26,32]*N**2 is < 1e-5
    # n=1000: https://www.wolframalpha.com/input?i=sqrt%282%29+*+gamma%28500.5%29+%2F+gamma%28500%29 
    ...
    def chiN(dimension):
        ...
        True
        >>> 31.6148718 < um.Mh.chiN(1000) < 31.6148722  # (um.Mh.chiN(1000), 31.614871896980080)
        True
        ...
        try:
            ...
            MathHelperFunctions._chiN_dict[dimension] = \
                N**0.5 * (1 - 1. / (4 * N) + 1. / (32 * N**2)) # was 26 was 21
        return MathHelperFunctions._chiN_dict[dimension]
    @staticmethod
