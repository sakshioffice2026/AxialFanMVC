...
"D:\Office\AxialFanMVC.Business\Cfd\Render\venv\Scripts\python.exe" "D:\Office\AxialFanMVC.Business\Cfd\Render\render_dispatch.py" "D:\Office\CfdIpc" >> "D:\Office\CfdIpc\dispatch.log" 2>&1
