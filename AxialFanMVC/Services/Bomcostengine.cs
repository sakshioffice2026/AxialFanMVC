...
namespace AxialFanMVC.Services
{
    ...
    // ═══════════════════════════════════════════════════════════════
    // BomResult / BomLineItemData — transient calculation DTOs returned
    // by BomCostingEngine.Calculate. Same pattern as AeroCalcResult /
    // StructCalcResult: pure in-memory results, no DB access. The
    // caller (BomController.Generate) maps BomLineItemData -> the real
    // BomLineItem EF entity for persistence; these two are intentionally
    // NOT EF entities themselves.
    // ═══════════════════════════════════════════════════════════════
